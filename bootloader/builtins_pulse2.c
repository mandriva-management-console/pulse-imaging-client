...
/* n'affiche pas les strings associ�s � la table*/
...
// pour systeme information cette fonction peut etre utilise pour recup�rer 
// manufacture, product name,Version et serial number.
// ne pas utiliser cette fonction pour recup�rer les valeurs decrites ci-dessous
// la version 2.1 � 2.3.4 inclut UUID et Wakon_land 
...
int identify_func(char *arg, int flags) {
    ...
    if (strstr(arg, "L=fr_FR")) {
        title_prompt = "\n\
�������͵  D�claration d'un poste client au serveur Pulse Imaging  ����������\n\
\n\
...
";
        ...
        title_prompt = "\n\
�����������͵  Registre um computador com o Servidor de Imagem Pulse  ��������������\n\
\n\
...
\n\
    Aten�ao: Quando possivel, use o nome da maquina com ID.\
";
        ...
        title_prompt = "\n\
�����������͵  Register a computer with a Pulse Imaging Server  ��������������\n\
\n\
