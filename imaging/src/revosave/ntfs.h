...
/* 10 */ unsigned char  fats            __attribute__((packed));        //Not used NTFS
/* 11 */ unsigned short entries         __attribute__((packed));        //Not used NTFS
/* 13 */ unsigned short sect_in_vol     __attribute__((packed));        //Not used NTFS
/* 15 */ unsigned char  descriptor      __attribute__((packed));
/* 16 */ unsigned short sect_in_fat     __attribute__((packed));        //Not used NTFS
...
/* 20 */ unsigned long sect_in_vol2     __attribute__((packed));        //Not Used NTFS (offset 0x20)
/* 24 */ unsigned long nu               __attribute__((packed));        //Not Used NTFS (offset 0x24)
